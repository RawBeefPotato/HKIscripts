...
quillforumblock.on('text-change', function(delta, oldDelta, source) { document.querySelector('#editorTextareaForum').innerHTML = JSON.stringify(quillforumblock.root.innerHMTL); 
